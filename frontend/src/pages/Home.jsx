...
export default function Home() {
  return (
    <div className="min-h-screen w-full p-20">
      ...
      <section className="w-full max-w-4xl mx-auto flex flex-col gap-4 sm:flex-row">
        <div className="flex flex-col items-center gap-2 w-64 h-64 rounded-full bg-black">
          <img
